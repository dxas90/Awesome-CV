...
%---------------------------------------------------------
  \cventry
    {DevOps Consultant Specialist} % Job title
    {Optimalbit LLC} % Organization
    {Minsk, Belarus (Remote)} % Location
...
%---------------------------------------------------------
  \cventry
    {Computer Systems Administrator \& DevOps Engineer} % Job title
    {Optimalbit LLC} % Organization
